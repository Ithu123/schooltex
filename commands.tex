...
\newcommand{\handlesubcaptions}[1]{%
    \readlist\captionlist{#1}
    \foreachitem\i\in\captionlist{
        \expandafter\providecommand\csname scaption\romannumeral\the\value{captioncounter}\endcsname {\i}
  ...
  \begin{figure}[h!]
    ...
    \foreachitem\i\in\figruelist{
      \begin{subfigure}{\subfigurewidth} % Adjust the width dynamically
        ...
        \csname scaption\romannumeral\the\value{captioncounter}\endcsname
        \stepcounter{captioncounter}
      \end{subfigure}%
    }
    \setcounter{captioncounter}{1}
